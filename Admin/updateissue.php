...
$sql = "UPDATE tmsissues SET AdminRemark=:remark WHERE  id=:iid";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      <td colspan="2" class="fontkink2" style="padding-left:0px;"><div class="fontpink2"> <b>Update a Remark !!!</b></div></td>
      ...
      <td colspan="2" ">  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
            ...
            <tbody>
<?php 
$sql = "SELECT * from tmsissues where id=:iid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':iid',$iid, PDO::PARAM_STR);
$query->execute();
...
?>
    ...
    <tr>
      ...
      <td  class="fontkink"> <input type="submit" name="submit2"  value="Submit"   size="40" style="cursor: pointer;" /></td>
    </tr> 
    <?php } else { ?>
     <tr>
