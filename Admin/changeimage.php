...
$query->execute();
$msg="your Package has been  Created Successfully";
...
<?php include('included/header.php');?>
	...
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Change Package Image </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit" class="btn-primary btn">Change</button>
