...
<div class="bg-sidebar vh-100 w-50 position-fixed">
            ...
            <div class=" bg-list d-flex flex-column align-items-center fw-bold gap-2 mt-4 ">
                <ul class="d-flex flex-column list-unstyled">
                        <li class="h7"><a class="nav-link text-dark" href="dashboard2.php"><span>Home</span></a></li>
                    <li class="h7"><a class=" nav-link text-dark" href="createpackage.php"> <span>Add Packages</span></a></li>
                    <li class="h7"><a class=" nav-link text-dark" href="managepackages.php"><span>Edit Packages</span></a></li>
                    <li class="h7"><a class=" nav-link text-dark" href="manageuser.php"><i<span>Manage Users</span></a></li>
                    <li class="h7"><a class=" nav-link text-dark" href="managebooking.php"><i<span>Manage bookings</span></a></li>
                    <li class="h7"><a class=" nav-link text-dark" href="manageissues.php"><span>Manage Issues</span></a></li>
                    <li class="h7"><a class=" nav-link text-dark" href="manageenquires.php"><span>Manage enquiries</span></a></li>
                </ul>
